...
app.post('/', (req, res) => {
    ...
    const options = { width: configs.width, height: configs.height, border: { top: '0px', bottom: '0px', left: '0px', right: '0px' } };
    const html = "<html style='margin: 0;padding: 0;border: 0;'>" +
        "<body style='margin: 0;padding: 0;border: 0;'>" +
        "<style>@page {margin: 0px;margin-top:0px;sheet-size:708px 1024px;}</style>" +
        configs.html +
        "</body></html>";
